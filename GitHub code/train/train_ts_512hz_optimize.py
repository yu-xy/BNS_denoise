...
def normal_train():
    model = keras.models.load_model('../model/train_512_ts_optimize_snr20-40_80s_0.0247778_27+9.h5')
    model.summary()
    # model = unet3()
    model_denoise = keras.models.load_model('../model/new_512_model/train_512_ts_bottomtrans_reseunet_snr20-40_80s_0.0556659_22+17.h5', \
                                        custom_objects={"EncoderModel_6": EncoderModel_6})
    # optimizer = Adam(lr=1e-4)
    # model.compile(optimizer=optimizer, loss=con_loss)
    ...
    # check_point = ModelCheckpoint('train_512_ts_bottomtrans_reseunet_snr20-40_5s_{val_loss:.7f}_{epoch:02d}epoch.h5', monitor='val_loss',\
    #                               verbose=1, save_best_only=True, mode='min')
    check_point = ModelCheckpoint(filepath='train_512_ts_optimize_snr20-40_80s_{val_loss:.7f}_{epoch:02d}+36.h5')

...
def normal_train():
    # model = seunet()
    model = keras.models.load_model('../model/train_512_ts_bottomtrans_reseunet_snr20-40_80s_0.0556659_22+17.h5', \
    ...
    check_point = ModelCheckpoint(filepath='../512_trans/train_512_ts_bottomtrans_reseunet_snr20-40_80s_{val_loss:.7f}_{epoch:02d}.h5')

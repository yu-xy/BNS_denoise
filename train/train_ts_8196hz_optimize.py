...
def normal_train():
    model = unet3()
    # model = keras.models.load_model('../model/train_peak_8192_ts_optimize_snr20-40_5s_0.0009473_26+18epoch.h5')
    # model.summary()
    model_denoise = keras.models.load_model('../model/new_8192_model/train_peak_8192_ts_bottomtrans_reseunet_snr20-40_5s_0.0013814_10+30.h5', \
    ...
    valid_iter = get_train_batch_iter(batch_size=batch_size,sample_length=sample_length,snr_list=snr_list,\
                                           peak_range=peak_range,freq=freq, snr_change_time=snr_change_time,\
                                           datapath=valid_datapath)
    check_point = ModelCheckpoint('train_peak_8192_ts_optimize_snr20-40_5s_{val_loss:.7f}_{epoch:02d}.h5')
